...
class AuthForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: Column(
        children: [
          FormTextField(label: "Email", controller: emailController, validator: Usuario.validarEmailForm),
          SizedBox(height: 16),
          FormTextField(label: "Senha", controller: senhaController, isPassword: true, validator: Usuario.validarSenha),
          ...
          if (!isLogin) ...[
            ...
            SizedBox(height: 16),
            FormTextField(label: "Nome", controller: nomeController, validator: Usuario.validarNomeForm),
            SizedBox(height: 16),
            FormTextField(label: "Sobrenome", controller: sobrenomeController, validator: Usuario.validarSobrenomeForm),
            SizedBox(height: 16),
